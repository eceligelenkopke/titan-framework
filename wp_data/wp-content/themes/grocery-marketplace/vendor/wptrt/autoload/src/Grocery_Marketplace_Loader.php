...
class Grocery_Marketplace_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function grocery_marketplace_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function grocery_marketplace_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function grocery_marketplace_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function grocery_marketplace_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->grocery_marketplace_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function grocery_marketplace_load( $class ) {
