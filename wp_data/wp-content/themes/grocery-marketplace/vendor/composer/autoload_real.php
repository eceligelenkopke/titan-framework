...
class Grocery_Marketplace_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function grocery_marketplace_loadClassLoader($class)
    {
    ...
    public static function grocery_marketplace_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
