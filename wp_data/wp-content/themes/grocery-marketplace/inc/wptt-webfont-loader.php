...
if ( ! class_exists( 'Grocery_Marketplace_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Grocery_Marketplace_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'grocery_marketplace_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function grocery_marketplace_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Grocery_Marketplace_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'grocery_marketplace_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function grocery_marketplace_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Grocery_Marketplace_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
