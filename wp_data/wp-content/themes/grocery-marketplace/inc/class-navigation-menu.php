...
if (!class_exists('Grocery_Marketplace_Menu_Page')) {
    /**
     * CUSTOM PAGE WALKER
     * A custom walker for pages.
     */
    class Grocery_Marketplace_Menu_Page extends Walker_Page
    {
        ...
        public function start_el(&$output, $page, $depth = 0, $args = array(), $current_page = 0)
        {
            ...
            if ('' === $page->post_title) {
                ...
                $page->post_title = sprintf(__('#%d (no title)', 'grocery-marketplace'), $page->ID);
            }
            ...
            if (isset($args['show_toggles']) && true === $args['show_toggles']) {
                if (isset($args['pages_with_children'][$page->ID])) {
                    ...
                    $args['list_item_after'] = '<button type="button" class="theme-aria-button submenu-toggle" data-toggle-target="' . $toggle_target_string . '" data-toggle-type="slidetoggle" data-toggle-duration="250"><span class="btn__content" tabindex="-1"><i class="fas fa-chevron-down"></i></span></button>';
                }
            }
